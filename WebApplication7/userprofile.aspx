<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="WebApplication7.userprofile" %>
                            ...
                            <div class="col">
                                <center>
                                   <h4>Your Profile</h4>
                                    ...
                                    <asp:Label class="badge badge-pill badge-info" ID="Label1" runat="server" Text="activ"></asp:Label>
                                </center>
                             </div>
                         </div>  
                         <div class="row">
                                ...
                                <label>Contact Number</label>
                                  <div class="form-group">
                                      <asp:TextBox CssClass="form-control" ID="TextBox3"
                                          runat="server" placeholder="Contact Number" TextMode="Phone"></asp:TextBox>
                                   </div>
                             </div>
